...
Highlights: WooCommerce Delivery Date is displayed on the product page, cart page, checkout page, thank you page and admin order details page. 

= How does it work? =

The WooCommerce estimated delivery date plugin provides very intuitive steps to configure the setup. All you have to do is set minimum number of delivery days for all products, set day’s cut off limit, and select working days of the week, and you are good to go!
...
= Can I set different delivery days for different group of products..? =
Yes you can. You can create different shipping classes for different groups of products and then set delivery days based on the shipping classes.

= What about the non-working days..? Will I be able to provide delivery dates excluding non-working days..? =
WooCommerce Estimated Delivery Date plugin allows you to specify the working days. Based on your working days, the plugin will adjust the delivery dates and provide the delivery estimate excluding the non-working days.

= Is it possible to set a woocommerce delivery time for accepting deliveries for all working days? =
Yes, using the WooCommerce Delivery Plugin, you can easily set a cut off time for each working day. Beyond the cut off time, the deliveries will be scheduled for next working day.
...
2. Delivery Date Setup Based On Shipping Classes

3. Delivery Date On Cart Page
...
* Improvements in case of Multi Site

1.2.5
Content Change : Author details and contributors

1.2.4
Tested with Woocommerce 3.4.x

1.2.3
Improvements : Added pot translation file and French language translation
